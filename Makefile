...
# Project:  project.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -spec linux-g++-64 CONFIG+=debug -o Makefile project.pro
#############################################################################
...
DISTDIR = /home/dmitry/Рабочий\ стол/project/project/project/.tmp/project1.0.0
LINK          = g++
LFLAGS        = -m64
...
Makefile: project.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec linux-g++-64 CONFIG+=debug -o Makefile project.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents dialog.h sender.h reciver.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp dialog.cpp sender.cpp reciver.cpp $(DISTDIR)/
...
moc_dialog.cpp: reciver.h \
		sender.h \
		dialog.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64 -I'/home/dmitry/Рабочий стол/project/project/project' -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/usr/include/c++/5 -I/usr/include/x86_64-linux-gnu/c++/5 -I/usr/include/c++/5/backward -I/usr/lib/gcc/x86_64-linux-gnu/5/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/5/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include dialog.h -o moc_dialog.cpp
...
reciver.o: reciver.cpp reciver.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o reciver.o reciver.cpp
